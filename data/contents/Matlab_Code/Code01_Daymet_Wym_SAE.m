...
Address_Result='C:\Utah State\Utah State University\Summer_2018\Paper_1\Summer_2018_Version\MatlabGeotiffResults\Wyoming\Budd';
...
for i=2014:2016
    ...
    if i==2014
        ...
        Sheet_Excel=2;
        BoundExcel_WS = 'F4:F368';
        BoundExcel_C =  'H4:H368';

        cd(Address_GeoTiff_2014)
    elseif i==2015
        cd(Address_Excel_Summary)
        Sheet_Excel=2;
        BoundExcel_WS = 'F369:F733';
        BoundExcel_C =  'H369:H733';

        cd(Address_GeoTiff_2015)
    else
        cd(Address_Excel_Summary)
        Sheet_Excel=2;
        BoundExcel_WS = 'F734:F1098';
        BoundExcel_C =  'H734:H1098';
    ...
    if i==2014
        cd(Address_Result)
        FileName_MAE='Daymet_2014_Wym_Budd_SAE';

    elseif i==2015
        cd(Address_Result)
        FileName_MAE='Daymet_2015_Wym_Budd_SAE';

    else
        cd(Address_Result)
        FileName_MAE='Daymet_2016_Wym_Budd_SAE';
